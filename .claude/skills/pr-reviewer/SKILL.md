...
6. Run the helper script `!python .kimi/skills/pr-reviewer/scripts/analyze_diff.py $ARGUMENTS` to get a structured diff summary before analyzing individual files.
